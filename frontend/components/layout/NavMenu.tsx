...
export default function NavMenu() {
  ...
  const { isAdmin } = useAuth(); // checks if admin is logged in
  ...
  return (
    <>
      <nav className="bg-gray-100 text-sm text-gray-800 relative z-10 border-b border-gray-200 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between md:justify-start gap-6 flex-wrap">
          {/* 🔘 Sidebar Toggle */}
          <button
          ...
          {/* 🔗 Navigation Links (scrollable row, no scrollbar) */}
          <div className="flex gap-4 text-sm overflow-x-auto whitespace-nowrap scrollbar-hide scroll-smooth">
            {[
